...
### Game 5: Prophecy Paradox

I wanted to make another improv game and this one came to mind. It sort of combines mad-libs and improv together! Players will fill in a "prophecy" for a random player. Once filled out, the randomly picked player will have to justify HOW or WHY that is their future. Basically, the hot seat player can choose to either follow it or resist it. At the end, players choose whether or not the prophecy is fulfilled (followed) or if it's a time paradox (resisted).

I figured this game could lead to some pretty funny moments, especially knowing who the target is when filling out the prophecy. I thought about making it an objective based one (avoid a time paradox), but I thought moments could really go either way to make it a great game. Instead, I opted to just keep track of the paradox instead.
